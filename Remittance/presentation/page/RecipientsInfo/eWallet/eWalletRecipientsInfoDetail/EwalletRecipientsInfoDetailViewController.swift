//
//  EwalletRecipientsInfoViewController.swift
//  CobaLogin
//
//  Created by developer on 16/03/23.
//
...
class EwalletRecipientsInfoDetailViewController: UIViewController {
    ...
    @IBAction func nextButtonRecipientsTapped(_ sender: Any) {
        ...
        let nib = EwalletAdditionalInfoDetailViewController(nibName: "EwalletAdditionalInfoDetail", bundle: nil)
        navigationItem.backBarButtonItem = UIBarButtonItem(title: "", style: .plain, target: nil, action: nil)
